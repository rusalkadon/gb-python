...
print(worker.name)  # Иван
print(worker.surname)  # Иванов
print(worker.position)  # Менеджер
print(worker.get_full_name())  # Иванов Иван
print(worker.get_total_income())  # 60000
